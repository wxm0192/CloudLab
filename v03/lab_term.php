 ...
 var lid  ;
	...
	?>
        ...
        if(lab_id != lid && lab_id != 0 ) {
                ...
                window.location.href = 'http://8.142.163.140:31656/v03/diff_lab.php?lab_id=' + lab_id;
                }
        else {
...
-->
		...
		var lab_remain_time = 0;
			...
			lab_exit = 1 ;
                ...
                function get_lab_infor() {
					...
					lab_remain_time = lab_infor[0].time_limit - 0 ;
                        ...
                        request.open("GET", "http://8.142.163.140:31656/v03/get_lab_info.php?lab_id=" + lab_id);
                        request.setRequestHeader("If-Modified-Since", "0");
                        request.setRequestHeader("Cache-Control", "no-cache");
                        request.send();
                }
			...
			if(lab_remain_time < 0)
			{
				...
				//window.open('http://8.142.163.140:31656/v03/list-table03.php' ) ;
				return ;
			}
