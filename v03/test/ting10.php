...
<head>
		...
		*/
			...
			var x = this.offsetLeft + this.clientWidth + 5 + 'px';
			var y = this.offsetTop - 5 + 'px';
                        ...
                        if (this.offsetLeft > mid_X) {
                                //x = document.body.clientWidth - btn.clientWidth + 5 + 'px';
                                x = document.body.clientWidth - this.offsetLeft + 50 + 'px';
                                txt3.style.right = x;
                                txt3.style.position = "absolute";
                                console.log("offsetRight: "+ x) ;
                        }
...
<body>
        ...
        <br><br>
        <button id="btn" ; class="button" ; onmouseover="d_load()" ; onmouseout="d_unload()" ; style="left: 50px; position: absolute"; >在图片后面添加文本</button>
        <button id="btn" ; class="button" ; onmouseover="d_load()" ; onmouseout="d_unload()" ; style="right: 50px; position: absolute"; >在图片后面添加文本</button>
        <script>
