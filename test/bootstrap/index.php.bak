...
function StartConnect(){
                document.getElementById("ri").src="http://8.142.163.140:31655/?hostname=172.30.2.180&username=root&password=V2FCQzI0ODA="
}
function setflag(){
               flag = 1 ;
}
...
function startCount(){
    ...
    // 创建 XMLHttpRequest 对象
        ...
        if(this.readyState === 4 && this.status === 200) {
                document.getElementById("ri").src= "http://8.142.163.140:31656/v02/update_redo.php?redo="+redo_count  ;
                var needle ='Running';
                 ...
                 if(str_op > 1)
                {
                        ...
                        //document.getElementById("external").src= "http://8.142.163.140:31656/test/msg/update_redo.php?redo="+redo_count  ;
                        var strs= new Array(); //定义一数组
                        //var url_str ;
                        strs=this.responseText.split(":"); //字符分割
                        url_str = "http://8.142.163.140:31655/?hostname="+strs[2] +"&username=root&password=V2FCQzI0ODA=";
			...
			get_public_ip() ;
                 ...
                 if(str_op > 1)
                {
                        ...
                        var url_str ;
                        strs=this.responseText.split(":"); //字符分割
                        url_str = "http://8.142.163.140:31656/v02/return_home.php" ;                                           
        ...
        request.open("GET", "http://8.142.163.140:31656/v02/update_progress.php");
...
function request_send(lab_id_i){
    ...
    // 创建 XMLHttpRequest 对象
        ...
        //document.getElementById("msg2").innerHTML =   "http://8.142.163.140:31656/test/msg/get_lab_session_id_ip.php?redo=1&lab_id="+lab_id_i ;
        request.open("GET", "http://8.142.163.140:31656/v02/get_lab_session_id_ip.php?redo=1&lab_id="+lab_id_i);
        request.setRequestHeader("If-Modified-Since","0");
        request.setRequestHeader("Cache-Control","no-cache");
        request.send();
        redo_count++ ;
...
function get_public_ip(){
    ...
    // 创建 XMLHttpRequest 对象
        ...
        //document.getElementById("msg1").innerHTML =   "msg1 : lab_id in JS : "+lab_id_i ;
        //document.getElementById("msg2").innerHTML =   "http://8.142.163.140:31656/test/msg/get_lab_session_id_ip.php?redo=1&lab_id="+lab_id_i ;
        request.open("GET", "http://8.142.163.140:31656/v02/get_public_ip.php");
        request.setRequestHeader("If-Modified-Since","0");
        request.setRequestHeader("Cache-Control","no-cache");
        request.send();
         //setTimeout(startCount,1000);
...
function release_lab(){
    ...
    // 创建 XMLHttpRequest 对象
        ...
        request.open("GET", "http://8.142.163.140:31656/v02/release_lab.php");
        request.setRequestHeader("If-Modified-Since","0");
        request.setRequestHeader("Cache-Control","no-cache");
        request.send();
}
