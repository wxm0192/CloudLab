...
if($type == "docker")
	{
	echo "<iframe id=\"bi\" name=\"bottom\" src=\"http://8.142.163.140:31655/?hostname=".$ip_addr."&username=root&password=cm9vdAo=\" frameborder=\"0\" style=\"width:100%;border:none;position:absolute;bottom:0px;left:0px;z-index:2;\"></iframe>" ;
	}
	else
	{
	echo "<iframe id=\"bi\" name=\"bottom\" src=\"http://8.142.163.140:31655/?hostname=".$ip_addr."&username=root&password=V2FCQzI0ODA=\" frameborder=\"0\" style=\"width:100%;border:none;position:absolute;bottom:0px;left:0px;z-index:2;\"></iframe>" ;
	}
?>
</body>
</html>
