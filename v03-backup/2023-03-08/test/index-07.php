...
-->
        ...
        <iframe id="li" name="left" src="left_1.html" frameborder="1"
                style="height:85%;border:thick;position:absolute;left:0px;top:15%;z-index:1;border: 1px solid;"></iframe>


        <div id="s" style="height:85%;position:absolute;z-index:3;cursor:move;top:15%;">
                <img style="height:100%;top:10%;position:absolute;z-index:1;position:absolute;"
                        src="https://images2017.cnblogs.com/blog/391710/201708/391710-20170806153534897-940657970.png" />
                <div style="height:85%;width:100%;position:absolute;z-index:2;margin-left:0px;top:10%;;padding:0px;filter:alpha(opacity=0);opacity:0;background-color:#fee;position:absolute;"
                        id="drag"></div>
        </div>
...
-->
        <iframe id="ri" name="right" frameborder="1"
                style="height:85%;border:thick;position:absolute;top:15%;right:0px;z-index:1;border: 1px solid;"></iframe>
