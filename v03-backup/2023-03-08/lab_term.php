		...
		var lab_remain_time = 0;
                ...
                function get_lab_infor() {
					...
					lab_remain_time = lab_infor[0].time_limit - 0 ;
                        ...
                        request.open("GET", "http://8.142.163.140:31656/MySQL/create_lab_env/test/get_lab_info.php?lab_id=" + lab_id);
                        request.setRequestHeader("If-Modified-Since", "0");
                        request.setRequestHeader("Cache-Control", "no-cache");
                        request.send();
                }
			...
			if(lab_remain_time < 0)
			{
				...
				//window.open('http://8.142.163.140:31656/MySQL/create_lab_env/test/list-table03.php' ) ;
				return ;
			}
